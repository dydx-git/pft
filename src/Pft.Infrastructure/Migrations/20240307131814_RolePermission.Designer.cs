...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Users.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Users.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Pft.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Apartments.Apartment", b =>
                {
                    b.OwnsOne("Pft.Domain.Shared.Money", "CleaningFee", b1 =>
                        {
                    ...
                    b.OwnsOne("Pft.Domain.Shared.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Pft.Domain.Entities.Apartments.ValueObjects.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Bookings.Booking", b =>
                {
                    b.HasOne("Pft.Domain.Entities.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                        .HasConstraintName("fk_bookings_apartments_apartment_id");

                    b.HasOne("Pft.Domain.Entities.Users.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_bookings_users_user_id");

                    b.OwnsOne("Pft.Domain.Shared.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Pft.Domain.Shared.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Pft.Domain.Shared.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Pft.Domain.Entities.Bookings.ValueObjects.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("Pft.Domain.Entities.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
            ...
            modelBuilder.Entity("Pft.Domain.Entities.Users.RolePermission", b =>
                {
                    b.HasOne("Pft.Domain.Entities.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("Pft.Domain.Entities.Users.Role", null)
                        .WithMany()
